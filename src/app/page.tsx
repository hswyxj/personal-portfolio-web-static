...
export default function Home() {
  ...
  const [profile, setProfile] = useState<Profile>(
    ...
    "hero_intro": "10+年计算机专业工作经验，其中7年前端 + 2年前后端一体 + 3年测试/测开背景的全栈工程师，擅长从0到1交付业务系统与工程化架构，兼顾性能、质量与上线效率。"
}
  );
